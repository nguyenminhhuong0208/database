        ...
        if ($get_product->rowCount() > 0) {
            while ($fetch_p = $get_product->fetch(PDO::FETCH_ASSOC)) {
                ...
                $insert_order->execute([
                    ...
                    $method,
                    $fetch_p['id'],
                    $fetch_p['price'] - $fetch_p['price'] * $discounted_total / 100,
                    $_GET['qty'],
                    "in progress"
                ]);
        ...
        if ($verify_cart->rowCount() > 0) {
            while ($f_cart = $verify_cart->fetch(PDO::FETCH_ASSOC)) {
                ...
                $insert_order->execute([
                    ...
                    $method,
                    $f_cart['product_id'],
                    $f_cart['price'] - $f_cart['price'] * $discounted_total / 100,
                    $f_cart['qty'],
                    "in progress"
                ]);
            }
                    ...
                    <div class="box-container">
                        ...
                        if (isset($_GET['get_id'])) {
                            ...
                            while ($fetch_get = $select_get->fetch(PDO::FETCH_ASSOC)) {
                                $sub_total = $fetch_get['price'] * $_GET['qty'];
                        ...
                        ?>
                                <div class="flex">
                                    ...
                                    <div>
                                        ...
                                        <p class="price"><?= $fetch_get['price']; ?> x <?= $_GET['qty'] ?></p>
                                    </div>
                                </div>
                                <?php
                            }
